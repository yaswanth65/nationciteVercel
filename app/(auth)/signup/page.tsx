    ...
    <nav className="steps">
      ...
      >
        <div className="step-main">
          <span className="step-icon">{step == 1 || step > 1 ? <img src="./dummy/tick.png" alt="Completed" style={{ height: '22px' }} /> : <img src="./dummy/Loader.png" alt="Completed" style={{ height: '25px' }} />}</span>
          <div className={`step-text-wrapper ${step > 1 ? 'is-completed' : ''}`}>
        ...
        <span className="step-arrow"> {step == 1 || step > 1 ? <img src="./dummy/arrow.png" alt="arrow" style={{ height: '22px' }} /> : <img src="./dummy/garrow.png" alt="arrow" style={{ height: '22px' }} />}</span>
      </div>
      <div
        className={`step-item ${step === 2 ? 'current' : ''
          } ${step > 2 ? 'completed' : ''} ${step < 2 ? 'disabled' : ''}`}
      >
        <div className="step-main">
          <span className="step-icon">{step == 2 || step > 2 ? <img src="./dummy/tick.png" alt="Completed" style={{ height: '22px' }} /> : <img src="./dummy/Loader.png" alt="Completed" style={{ height: '25px' }} />}</span>
          <div className={`step-text-wrapper ${step > 2 ? 'is-completed' : ''}`}>
        ...
        <span className="step-arrow"> {step == 2 || step > 2 ? <img src="./dummy/arrow.png" alt="arrow" style={{ height: '22px' }} /> : <img src="./dummy/garrow.png" alt="arrow" style={{ height: '22px' }} />}</span>
      </div>

      <div
        className={`step-item ${step === 3 ? 'current' : ''
          } ${step > 3 ? 'completed' : ''} ${step < 3 ? 'disabled' : ''}`}
      >
        <div className="step-main">
          <span className="step-icon">{step == 3 || step > 3 ? <img src="./dummy/tick.png" alt="Completed" style={{ height: '22px' }} /> : <img src="./dummy/Loader.png" alt="Completed" style={{ height: '25px' }} />}</span>
          <div className={`step-text-wrapper ${step > 3 ? 'is-completed' : ''}`}>
            <div className="step-title">Additional Verification</div>
            <div className="step-subtitle">
              Provide verification of account
            </div>
          </div>
        </div>
        <span className="step-arrow"> {step == 3 || step > 3 ? <img src="./dummy/arrow.png" alt="arrow" style={{ height: '22px' }} /> : <img src="./dummy/garrow.png" alt="arrow" style={{ height: '22px' }} />}</span>
      </div>

      <div
        className={`step-item ${step === 4 ? 'current' : ''
          } ${step > 4 ? 'completed' : ''} ${step < 4 ? 'disabled' : ''}`}
      >
        <div className="step-main">
          <span className="step-icon">{step == 4 || step > 4 ? <img src="./dummy/tick.png" alt="Completed" style={{ height: '22px' }} /> : <img src="./dummy/Loader.png" alt="Completed" style={{ height: '25px' }} />}</span>
          <div className={`step-text-wrapper ${step > 4 ? 'is-completed' : ''}`}>
            <div className="step-title">Discovery Questions</div>
            <div className="step-subtitle">
              How you&apos;ll use NationCite
            </div>
          </div>
        </div>
        <span className="step-arrow"> {step == 4 || step > 4 ? <img src="./dummy/arrow.png" alt="arrow" style={{ height: '22px' }} /> : <img src="./dummy/garrow.png" alt="arrow" style={{ height: '22px' }} />}</span>
      </div>
    </nav>
  );
  ...
  return (
    <div className="page">
      <aside className="sidebar">
        <div className="logo">
          <img src="./logo.png" alt="NationCite" style={{ height: '125px' }} />
        </div>
        <div>
      ...
      <main className="content">
        ...
        {step === 2 && role === 'researcher' && (
          <div className="auth-content">
            <h1 className="auth-title">Lorem ipsum dolor self amet (Researcher)</h1>
            <p className="subtitle">
              Lorem ipsum dolor sit amet, consectetur elite
            </p>
            ...
            >
              ...
              <label className="field">
                <span className="field-label">Password (6 or more characters)</span>
                <input
                  type="password"
              ...
              <p className="bottom-inline">
                Already on NationCite?  <Link href="/signin" className="link-btn">
                  Sign in here
                </Link>
              </p>
            </form>
        ...
        {step === 3 && role === 'researcher' && (
          <div className="auth-content">
            ...
            >
              <label className="field">
                <span className="field-label">Institution / Organization Name</span>
                <input
                  type="text"
                  placeholder="Placeholder"
              ...
              <label className="field">
                <span className="field-label">Institution ID / Registration Number</span>
                <input
                  type="text"
                  placeholder="Placeholder"
                  value={institutionId}
              ...
              <label className="field">
                ...
                <input type="email" placeholder="Email" disabled value={institutionEmail} />
              </label>

              <div className="upload-block">
                <p className="upload-title">Upload one of the following documents:</p>
                ...
                <label className="dropzone">
                  ...
                  <div className='box-upload'><img src="./dummy/upload-icon.png" alt="" style={{ height: '15px', textAlign: 'center' }} /></div>
        ...
        {step === 4 && role === 'researcher' && (
          <div className="auth-content">
            ...
            <form className="auth-form" onSubmit={handleSubmit}>
              <div className="pill-group">
                ...
                {[
                  ...
                  <button
                    key={item}
                    type="button"
                    className={`pill ${heardFrom.includes(item) ? 'pill-active' : ''}`}
                    onClick={() => toggleInArray(item, heardFrom, setHeardFrom)}
                  >
                    {item}
                  </button>
                ))}
              ...
              <div className="pill-group">
                <p className="field-label">What will you use NationCite for?</p>
                {[
                  'Conducting research',
                  'Managing citations',
                  'Publishing papers',
                  ...
                  <button
                    key={item}
                    type="button"
                    className={`pill ${useCase.includes(item) ? 'pill-active' : ''}`}
        ...
        {step === 2 && role === 'university' && (
          <div className="auth-content">
            <h1 className="auth-title">Lorem ipsum dolor self amet (University)</h1>
            <p className="subtitle">
              Lorem ipsum dolor sit amet, consectetur elite
            </p>
            ...
            >
              <label className="field">
                <span className="field-label">Enter your Organization / University</span>
                <input
                  type="text"
                  placeholder="Placeholder"
                  value={institutionName}
              ...
              <div className="field">
                <span className="field-label">Select your institution&apos;s governance type</span>
                <div className="radio-row">
                  <label className="radio-item">
                    <input type="radio" name="govType" value="private" defaultChecked />
                    <span>Private</span>
                  </label>
                  <label className="radio-item">
        ...
        {step === 3 && role === 'university' && (
          <div className="auth-content">
            ...
            >
              ...
              <label className="field">
                <span className="field-label">Organization / University ID</span>
                <input
                  type="text"
              ...
              <div className="upload-block">
                <span className="field-label">Official Letter of Authorization</span>
                <label className="dropzone">
                  <input type="file" onChange={handleFileChange} />
                  <div className="box-upload">
                    <img src="./dummy/upload-icon.png" alt="" style={{ height: '15px' }} />
                  </div>
                  <span>Drop your File here or click here to Upload</span>
                </label>
              </div>
...
{step === 2 && role === 'medical' && (
  <div className="auth-content">
    <h1 className="auth-title">Lorem ipsum dolor self amet (Doctor)</h1>
    <p className="subtitle">
      Lorem ipsum dolor sit amet, consectetur elite
    </p>
