      ...
      <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 top-mar">
        <div className="flex flex-col justify-center wid">
          ...
          <p className="para-graph">
            Whether you&apos;re a researcher seeking profile support, an institution
            exploring analytics, or a partner interested in collaboration our team
            is here to assist you with verified, secure, and transparent solutions.
          </p>
          <div className='mar-top'>
            ...
            <div className="flex flex-wrap gap-6 items-center text-gray-400 text-sm img-martop">
              <img src="/logos/Logo1.png" alt="Luminous" className="font-semibold text-gray-500" />
              <img src="/logos/Logo2.png" alt="Trace" className="font-semibold text-gray-500" />
              <img src="/logos/Logo3.png" alt="ProNature" className="font-semibold text-gray-500" />
              <img src="/logos/Logo4.png" alt="Nextmove" className="font-semibold text-gray-500" />
            </div>
          </div>
        </div>
        <div className="bg-white shadow-xl rounded-3xl p-6 md:p-8 border border-gray-100 mar-left">
          <form className="space-y-5">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Medical School / Affiliation <span className="text-red-500">*</span>
              </label>
              <input
                type="text"
                placeholder="Enter Input"
            ...
            <button
              type="submit"
              className="mt-2 w-full rounded-full bg-orange-500 px-4 py-2.5 text-sm font-semibold text-white hover:bg-orange-600 transition-colors"
            >
              Submit
            </button>
          </form>
