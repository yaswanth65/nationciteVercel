...
export default function LeaderboardPage() {
  return (
    <div className="min-h-screen bg-white font-sans">
      {/* Hero Section */}
      <section className="relative bg-linear-to-b from-[#FFF5EE] via-[#FFE4C8] to-[#FFD9B3] pt-20 pb-16 px-[72px] overflow-hidden">
        ...
        <div className="w-full max-2xl relative z-10">
          <div className="mb-12 mt-8">
            ...
            <p className="p1 text-[#5C5C5C] line-clamp-3 w-[40vw]">
