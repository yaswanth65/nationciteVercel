    ...
    <section className="w-full py-20 bg-white px-[76px]">
      <div className="w-full">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
          <div>
            <h3 className="text-[#1E1E1E] text-2xl md:text-3xl mb-6">
              Built on Transparency.
              <br />
              Governed by Data Integrity.
            </h3>
            <p className="p2 text-[#5C5C5C] mt-6 max-w-xl">
          ...
          <button className="bg-[#FF7A00] text-white px-4 py-2 rounded-xl font-medium hover:bg-[#e66e00] transition-colors md:-mt-3 md:self-end">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div
              key={i}
              className="bg-[#F5F5F5] p-10 rounded-2xl min-h-[450px] flex flex-col justify-end transparency-card"
            >
              <h4 className="text-[#1E1E1E] mb-8">{item.title}</h4>
